...
export type AuditAction =
  ...
  | "COMMODITY_PURCHASE_APPROVED_LOCAL_OVERRIDE"
  ...
  | "CUSTOMER_CREATED"
  | "CUSTOMER_UPDATED"
  | "CUSTOMER_CREDIT_SETTINGS_UPDATED"
  | "CREDIT_LIMIT_OVERRIDE_REQUESTED"
  | "CREDIT_LIMIT_OVERRIDE_APPROVED"
  | "CREDIT_LIMIT_OVERRIDE_APPROVED_LOCAL"
  | "CREDIT_LIMIT_OVERRIDE_REJECTED"
